...
plt.title('Average Annual Revenue by Topic', fontsize=12, fontweight='bold')
...
plt.title('Average Daily Rate (ADR) by Topic', fontsize=12, fontweight='bold')
...
plt.title('Average Annual Occupancy by Topic', fontsize=12, fontweight='bold')
